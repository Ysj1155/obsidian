...
SSD 인터페이스. PCI-Express의 약자. 다양한 주변 기기를 컴퓨터 시스템과 통신할 수 있도록 제어하고 데이터 전송을 담당한다. 예전에는 메인보드 슬롯에 꼽는 카드 형태의 장치에 사용했기 때문에 PCIe는 카드 형태의 폼팩터로 말하기도 하며 이때는 PCLe로 표기한다. 
