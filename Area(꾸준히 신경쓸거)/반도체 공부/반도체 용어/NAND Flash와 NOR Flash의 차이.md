...
Flash는 NAND건 NOR건 간에 block 단위로만 지울 수 있습니다. NAND의 경우에는 32개 또는 64개 page로 이루어져 있고, NOR도 128KB단위의 block 단위를 갖습니다. 특이한 경우는 NAND나 NOR의 erase는 0으로 지우는 것이 아니라, charging을 하는 경우라서 지우고 난 block은 모두 1로 채워져 있어서 16진수로 보면 0xFF로 가득 차 있습니다.